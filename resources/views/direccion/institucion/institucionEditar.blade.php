    ...
    <div class="f_cp__bottom">
        <div class="f_cp__bottom_left">
        	...
        	<div class="f_cp_bl_action-buttons">
                <button type="submit" form="formInstitucionEditar" class="f_button f_button--primary tight">GUARDAR</button>
...
<div class="f_card f_card--border mt-4">
    ...
    <div class="f_card__body">
    	...
    	<div class="w-full">
            <form action="{{ route('institucion.actualizar') }}" 
            		method="post" class="f_input-box--flat" id="formInstitucionEditar" enctype="multipart/form-data">
    						...
    						<td>
    							<div class="f_item_content sm:w-60">
    								<div class="f_image--ref">
    									<img alt="" src="{{ $institucion->getLogo }}" id="imgLogo">
    								</div>
    								<div class="pt-2">
    						...
    						<td>
    							<div class="f_item_content sm:w-60">
    								<input type="text" name="codigo_modular" 
    										value="{{ old('codigo_modular', $institucion->ITC_CODIGO_MODULAR) }}" required>
    							</div>
    						</td>
    					</tr>
    					<tr>
    						...
    						<td>
    							<div class="f_item_content sm:w-60">
    								<input type="text" name="nombre" 
    										value="{{ old('nombre', $institucion->ITC_NOMBRE) }}" required>
    							</div>
    						</td>
    					</tr>
    					<tr>
    						...
    						<td>
    							<div class="f_item_content sm:w-60">
    								<input type="text" name="director" 
    										value="{{ old('director', $institucion->ITC_DIRECTOR) }}" required>
    							</div>
    						</td>
    					</tr>
    					<tr>
...
f_formPreventSendWithEnter.init("formInstitucionEditar");
