    ...
    <div class="f_cp__bottom">
        <div class="f_cp__bottom_left">
        	...
        	<div class="f_cp_bl_action-buttons">
                <button type="submit" form="formNivelGuardar" class="f_button f_button--primary tight">GUARDAR</button>
...
<div class="f_card f_card--border mt-4">
    ...
    <div class="f_card__body">
    	...
    	<div class="w-full">
            <form action="{{ route('nivel.guardar') }}" 
            		method="post" class="f_input-box--flat" id="formNivelGuardar" enctype="multipart/form-data">
            	@csrf
...
f_formPreventSendWithEnter.init("formNivelGuardar");
